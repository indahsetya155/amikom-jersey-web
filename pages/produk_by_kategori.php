				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<?php 
							...
							//echo "</pre>";
							//exit();
							$namaKategori = $res['nama_kategori'];
						?>
						<h2 class="title text-center">Produk Berdasar Kategori <?php echo $namaKategori; ?></h2>
						<?php
						
						$q = mysqli_query($koneksi, "select * from tbl_produk where id_kategori_produk=$id");
