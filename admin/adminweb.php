      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-car"></i> <span>Biaya Kirim</span>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="adminweb.php?module=biaya"><i class="fa fa-circle-o"></i>Biaya</a></li>
              </ul>
            </li>
        ...
        <?php 
          ...
          if ($_GET['module']=='home') {
            ...
            include "module/biaya_kirim/list_biaya.php";
